...
# adapted from https://github.com/ultralytics/ultralytics/blob/main/examples/YOLOv8-ONNXRuntime/main.py
...
class YOLOv8:
    ...
    def __init__(self, onnx_model: str, input_image: str, confidence_thres: float, iou_thres: float):
        ...
        self.classes = YAML.load('..' + constants.PATH_YOLO_YAML)["names"]
...
if __name__ == "__main__":
    # Can run inference against locally stored images
    # from docker container home dir run with defaults as ..
    # python -m app.yolo_handler.yolov8_onnxruntime
    default_model = Path('/models/ecdyolo.onnx')
    test_img = Path('app/test/diabrotica.JPG')
    parser = argparse.ArgumentParser()
    parser.add_argument("--model", type=str, default=default_model, help="Input your ONNX model.")
    parser.add_argument("--img", type=str, default=test_img, help="Path to input image.")
    ...
    image.save('app/images/filename.jpeg')
